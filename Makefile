#############################################################################
# Makefile for building: SymulatorUAR_QT
# Generated by qmake (3.1) (Qt 6.8.1)
# Project:  SymulatorUAR_QT.pro
# Template: app
# Command: C:\Qt\6.8.1\mingw_64\bin\qmake.exe -o Makefile SymulatorUAR_QT.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: SymulatorUAR_QT.pro C:/Qt/6.8.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.8.1/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile SymulatorUAR_QT.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
